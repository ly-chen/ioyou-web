            ...
            if (results > 0) {
                ...
                try {
                    ...
                    if (newUser) {
                        ...
                        await firestore().collection('users').doc(uid).set({ name: name, username: username, email: email, actives: { 'Arts': false, 'Biology': false, 'Business': false, 'Computer Science': false, 'Economics': false, 'Finance': false, 'French': false, 'General': false, 'Humanities': false, 'Languages (General)': false, 'Mandarin': false, 'Psychology': false, 'Spanish': false } }).then(() => {
